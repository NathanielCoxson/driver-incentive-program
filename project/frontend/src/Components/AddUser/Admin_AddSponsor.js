...
function AdminAddSponsor() {
    ...
    const handleSubmit = (event) => {
        ...
        const user = {
            ...
            Role: 'sponsor', // Set the role to 'sponsor' for admin-added sponsors
    ...
    return (
        <main>
            <div className="sidebar-container">
                <AdminSidebar /> {/* Include the AdminSidebar component here */}
...
export default AdminAddSponsor;
